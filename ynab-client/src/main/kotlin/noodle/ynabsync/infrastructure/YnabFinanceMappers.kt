...
fun YnabAccount.toFinanceDomain() = noodle.ynabsync.core.domain.YnabAccount(id = id, name = name)

fun YnabAccount.Body.toFinanceDomain() =
    noodle.ynabsync.core.domain.YnabAccount.Body(accounts = accounts.map { it.toFinanceDomain() })

fun YnabAccount.Data.toFinanceDomain() =
    noodle.ynabsync.core.domain.YnabAccount.Data(data = data.toFinanceDomain())

fun YnabBudget.toFinanceDomain() = noodle.ynabsync.core.domain.YnabBudget(id = id, name = name)

fun YnabBudget.Body.toFinanceDomain() =
    noodle.ynabsync.core.domain.YnabBudget.Body(budgets = budgets.map { it.toFinanceDomain() })

fun YnabBudget.Data.toFinanceDomain() =
    noodle.ynabsync.core.domain.YnabBudget.Data(data = data.toFinanceDomain())

fun YnabTransaction.toFinanceDomain() =
    noodle.ynabsync.core.domain.YnabTransaction(id = id, accountId = accountId, amount = amount)
...
fun YnabTransaction.Data.toFinanceDomain() =
    noodle.ynabsync.core.domain.YnabTransaction.Data(data = data.toFinanceDomain())
