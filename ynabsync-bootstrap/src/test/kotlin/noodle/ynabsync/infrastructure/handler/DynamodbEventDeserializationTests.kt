...
class DynamodbEventDeserializationTests {
    ...
    fun deserializesInsertWithNewImage() {
        ...
        val raw = """{"Records":[{"eventID":"1","eventVersion":"1.1","dynamodb":{"Keys":{"id":{"S":"123"}},"NewImage":{"destination":{"S":"//user-123@app.ynab.com"},"source":{"S":"//user@gmail.com/messageId/msg-id"}},"ApproximateCreationDateTime":1747040400,"SequenceNumber":"111","SizeBytes":26,"StreamViewType":"NEW_IMAGE"},"awsRegion":"ap-southeast-1","eventName":"INSERT","eventSourceARN":"arn:aws:dynamodb:ap-southeast-1:123:table/outbox/stream/2026-05-12T00:00:00.000","eventSource":"aws:dynamodb"}]}"""
        ...
        assertEquals("//user-123@app.ynab.com", record.dynamodb.newImage["destination"]?.s)
        assertEquals("//user@gmail.com/messageId/msg-id", record.dynamodb.newImage["source"]?.s)
