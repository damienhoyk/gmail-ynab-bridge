...
class DynamodbEventDeserializationTests {
    ...
    fun deserializesInsertWithNewImage() {
        ...
        assertEquals("urn:app.ynab.com:user-123", record.dynamodb.newImage["destination"]?.s)
    ...
    fun deserializesModifyRecord() {
        val raw = """{"Records":[{"eventID":"2","eventVersion":"1.1","dynamodb":{"Keys":{"id":{"S":"456"}},"NewImage":{"destination":{"S":"urn:app.ynab.com:other-user"}},"ApproximateCreationDateTime":1747040401,"SequenceNumber":"222","SizeBytes":20,"StreamViewType":"NEW_IMAGE"},"awsRegion":"ap-southeast-1","eventName":"MODIFY","eventSourceARN":"arn:aws:dynamodb:ap-southeast-1:123:table/outbox/stream/2026-05-12T00:00:00.000","eventSource":"aws:dynamodb"}]}"""
